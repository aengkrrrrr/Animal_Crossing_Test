...
const resultConditions = [
    { condition: ['a', 'a', 'a', 'a', 'a', 'a'], result: 0 }, // 전부 'a'
    { condition: ['a', 'a', 'a', 'a', 'a', 'b'], result: 0 }, // 'b'가 1개
    { condition: ['a', 'a', 'a', 'a', 'b', 'b'], result: 0 }, // 'b'가 2개
    { condition: ['a', 'a', 'a', 'b', 'b', 'b'], result: 1 }, // 'b'가 3개 → 중립
    { condition: ['a', 'a', 'b', 'b', 'b', 'b'], result: 1 }, // 'b'가 4개
    { condition: ['a', 'b', 'b', 'b', 'b', 'b'], result: 2 }, // 'b'가 5개
    { condition: ['b', 'b', 'b', 'b', 'b', 'b'], result: 2 }, // 전부 'b'

    { condition: ['a', 'b', 'a', 'b', 'a', 'b'], result: 1 }, // a/b 섞인 경우
    { condition: ['b', 'a', 'b', 'a', 'b', 'a'], result: 1 },

    { condition: ['a', 'a', 'b', 'b', 'a', 'a'], result: 0 }, // a가 약간 많음
    { condition: ['b', 'b', 'a', 'a', 'b', 'b'], result: 1 }, // a/b 비슷함
    { condition: ['b', 'b', 'b', 'a', 'a', 'a'], result: 1 }, // b가 약간 많음

    { condition: ['b', 'b', 'b', 'b', 'a', 'a'], result: 2 }, // b가 우세
    { condition: ['a', 'a', 'a', 'b', 'b', 'a'], result: 0 }, // a가 우세
    { condition: ['b', 'a', 'b', 'b', 'a', 'b'], result: 2 }  // b가 많음
];
